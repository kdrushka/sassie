...
def standalone_main():
  ...
  if('L2' in plevel) == False:
    ...
    print ('Please goto the following link in the PODAAC Forum to download L3/L4 datasets:\n')
    print ('https://podaac.jpl.nasa.gov/forum/viewtopic.php?f=85&t=219&sid=6115218902d71b00cfdebc5adb6a2a58\n')
